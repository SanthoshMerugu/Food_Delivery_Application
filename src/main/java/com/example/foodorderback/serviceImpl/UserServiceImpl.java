...
//					new UsernamePasswordAuthenticationToken(login.getUsername(), login.getPassword()));
			...
			//compare the encrypted passwords and the ones that are not, because when I manually added users to the database to test, the passwords were not encrypted, that's the only reason I'm doing that check
//if the passwords are not the same (plain text from the input and in the database, i.e. the one that is not encrypted, check further
	...
	public String changePassword(PasswordDTO passwordDTO) {
		...
		//the plain text codes in the database are also checked because the test orders I made at the beginning
//they do not have encrypted codes. Passwords are encrypted after user registration and thus stored in the database
