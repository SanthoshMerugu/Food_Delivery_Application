...
public class UserController {
	...
	public ResponseEntity<String> createUser(@RequestBody User user) {
		...
		//if the user was successfully saved, the saveUser method returns "success", if not it returns "fail";
		else {
	...
	public ResponseEntity<String> updateUserByIdAndDetails(@PathVariable Long id, @RequestBody User employeeDetails) {
		...
		// ID and rolls are not sent from the front, so it is set here
	...
	//must be without consumes, because now no json object is sent, but only id in the path
